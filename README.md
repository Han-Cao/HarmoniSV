...
## Run time
The test code [test.sh](test/test.sh) process the output of 3 SV callers (i.e., Sniffles2, cuteSV, and SVIM) on HG002 chr22. The run time on a PC with i5-10600 is shown below (excluding time for SV discovery and merging by other tools).
